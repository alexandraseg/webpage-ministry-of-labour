...
<div class="wrapper bgded overlay gradient" style="background-image:url('../../images/demo/backgrounds/user.jpg');">
  ...
  <h6 class="heading">Επαναφορά Κωδικού</h6>
    
    <ul>
      <li><a href="../../index.php">Αρχική</a></li>
      <li><p class="active-breadcrumb">Επαναφορά Κωδικού<p></li>
    </ul>
        ...
        <div class="login-form">
            ...
            <h3>καλως ορισατε!</h3>
			      <form action="backend/reset.php" method = "post">
				        <div class="form-row">
                    <div class="username">
                        <label id="username">Όνομα Χρήστη</label>
                        <input name="username" type="text" pattern="[a-zA-Z0-9]+" required >
                    </div>
                </div>
                <div class="form-row">
                    <div class="password">
                        <label id="password">Nέος Κωδικός Χρήστη</label>
					              <input name="password" type="password"  pattern="[a-zA-Z0-9]+" required >
                    </div>
                </div>
				          <div class="log-btn">
                    <button type="submit" name="reset"><i class="fa fa-sign-in"></i>  Επαναφορά Κωδικού</button>
                </div>
            </form>
          </div>
          <div style="position: relative; bottom: -25px; right:-230px; " >
                <a href="login.php">Πίσω</a>
              </div>
      </div>
    </section>
