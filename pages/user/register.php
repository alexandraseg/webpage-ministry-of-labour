...
<div class="wrapper row3">
      ...
      <div class="register-page-content">
        ...
        <?php 
            ...
            <form action="backend/register.php" method = "post">
                <div class="form-row">                  
                  ...
                  <div class="form-column">
                    <label id="register-afm">Α.Φ.Μ. : *</label>
								...
								<div class="form-row" id="adt" style="display: none;">
                  <div class="form-column">
                    <label id="register-id_number">A.Δ.Τ. : *</label>
										<input id="id" name="id_number" type="text" placeholder="πχ ΑΒ102030" pattern="[a-zA-Z0-9 ]+"  >
                  </div>
                  <div class="form-column">
                    <label id="register-ergazomenos-address">Διεύθυνση: *</label>
										<input id="er_address" name="ergazomenos-address" type="text" placeholder="πχ Σοφοκλέους 3 , Περιστέρι" pattern="[a-zA-Zα-ωΑ-Ω0-9 ,]+"  >
								  </div>
                </div>
								<div class="form-row" id="eponimia" style="display: none;">
                  <div class="form-column">
                    <label id="register-shopname">Επωνυμία Επιχείρησης : *</label>
										<input id="shopname" name="shopname" type="text" placeholder="πχ ΠΑΠΑΔΟΠΟΥΛΟΣ Ο.Ε." pattern="[a-zA-Zα-ωΑ-Ω0-9 ,]+"  >
                  </div>
                  <div class="form-column">
                    <label id="register-shop-address">Διεύθυνση Επιχείρησης: *</label>
										<input id="shop_address" name="shop-address" type="text" placeholder="πχ Σοφοκλέους 3 , Περιστέρι" pattern="[a-zA-Zα-ωΑ-Ω0-9 ,]+"  >
								  </div>
								</div>
								<div class="form-row" id="name" style="display: none;">
									<div class="form-column">
                ...
                <div class="form-row">
                  <div class="form-column">
                    <label id="register-username">Όνομα Χρήστη(username): *</label>
  ...
  <script>
    function yesnoCheck(that) {
        if (that.value == "2" || that.value == "3" || that.value == "4" || that.value=="5") {
          document.getElementById("adt").style.display = "block";
          document.getElementById("name").style.display = "block";

          document.getElementById("er_address").required = true;
        ...
        if (that.value == "1") {
          document.getElementById("eponimia").style.display = "block";
          document.getElementById("shopname").required = true;
          document.getElementById("shop_address").required = true;
        } else {
          document.getElementById("eponimia").style.display = "none";
        }
    }
  </script>
</div>
