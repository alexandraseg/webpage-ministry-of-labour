...
<div class="wrapper bgded overlay gradient" style="background-image:url('../images/demo/backgrounds/emp.png');">
  ...
  <h6 class="heading">Εργοδότες</h6>
    
    <ul>
      <li><a href="index.html">Αρχική</a></li>
      <li><p class="active-breadcrumb">Εργοδότες<p></li>
    </ul>
  </div>
</div>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter first"> 
      <!-- ################################################################################################ -->
      <!-- <h1>Εργοδότες</h1> -->
      <p>Η σελίδα αυτή παρέχει μια συντόμευση για πληροφορίες και υπηρεσίες που προσφέρει το Υπουργείο Εργασίας και Κοινωνικών Υποθέσεων στους εργοδότες.</p>

      <p id="top1"><h2>Βοήθεια για τους εργοδότες - Κορωνοϊός</h2></p>
      <ul>
        <a href="empsuspinfo.php" style="color:black;" class="ex5"><li>Δήλωση αναστολής σύμβασης εργασίας</li></a>
        <a href="emperminfo.php" style="color:black;" class="ex5"><li>Δήλωση εξ αποστάσεως εργασίας</li></a>
        <li>Προστασία εργαζομένων από τους εργοδότες κατά τη διάρκεια της πανδημίας Covid-19</li>
        <li>Τι ισχύει για άδειες, ασφαλιστικές εισφορές και άλλα εργασιακά ζητήματα</li>
      </ul>

      <p id="top2"><h2>Επιχορηγήσεις και Συμβάσεις</h2></p>
        <ul>
        <li>Topic</li>
        <li>Topic</li>
        <li>Topic</li>
      ...
      <p id="top3"><h2>Μισθοί και Ώρες Εργασίας</h2></p>
        <ul>
        <li>Topic</li>
        <li>Topic</li>
        <li>Topic</li>
    ...
    <div class="sidebar one_quarter"> 
      ...
      <nav class="sdb_holder">
        <ul>
          <li><a href="#top1">Βοήθεια για τους εργοδότες - Κορωνοϊός</a></li>
          <li><a href="#top2">Επιχορηγήσεις και Συμβάσεις</a> </li>
          <li><a href="#top3">Μισθοί και Ώρες Εργασίας</a></li>
          <li><a href="#">Αποζημίωση των Εργαζομένων</a></li>
          <li><a href="#">Ασφάλεια και Υγεία στον Χώρο Εργασίας</a></li>
            </ul>
          </li>
        </ul>
      </nav>
