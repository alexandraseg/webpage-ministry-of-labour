...
<div class="wrapper bgded overlay gradient" style="background-image:url('../images/demo/backgrounds/covid.jpg');">
  ...
  <h6 class="heading">Κορωνοϊός - Κατευθυντήριες Οδηγίες</h6>
    
    <ul>
      <li><a href="index.php">Αρχική</a></li>
      <li><p class="active-breadcrumb">Κορωνοϊός - κατευθυντήριες οδηγίες<p></li>
    </ul>
  ...
  <section id="cta" class="hoc container clear"> 
    ...
    <ul class="nospace clear">
      <li class="one_quarter first">
        <div class="block clear"><a href="#"></a> <span><img src="../images/demo/backgrounds/c1.jpg"><br><br><a href="#topic1"><strong style="text-decoration: underline; color:black!important;">Ασφάλεια στον <br> Χώρο Εργασίας</strong></a></span></div>
      </li>
      <li class="one_quarter">
        <div class="block clear"><a href="#"></a> <span><img src="../images/demo/backgrounds/c2.jpg"><br><br><a href="#topic2"><strong style="text-decoration: underline; color:black!important;">Μισθοί, Ώρες και Άδειες</strong></a></span></div>
      </li>
      <li class="one_quarter">
        <div class="block clear"><a href="#"></a> <span><img src="../images/demo/backgrounds/c3.jpg"><br><br><a href="#topic3"><strong style="text-decoration: underline; color:black!important;"> Ασφάλεια Ανεργίας</strong></a></span></div>
      </li>
      <li class="one_quarter">
        <div class="block clear"><a href="#"></i></a> <span><img src="../images/demo/backgrounds/c4.jpg"><br><br><a href="#topic4"><strong style="text-decoration: underline; color:black!important;">Άλλα Θέματα</strong></a></span></div>
      </li>
    </ul>

     <div id="topic1" style="margin-left: 30px; margin-top: 30px; text-decoration: underline;"><h3><strong>Ασφάλεια στον Χώρο Εργασίας</strong></h3></div>
      <ul>
        <li><a href="prevention.php"><p style="color:black!important;">Μέτρα πρόληψης στους χώρους της εργασίας</p></a></li>
        <li><a href="management.php"><p style="color:black!important;">Διαχείριση περιστατικού εμφάνισης συμπτωμάτων στον χώρο εργασίας</p></a></li>
        <li><a href="#"><p style="color:black!important;">Όλα τα νέα για την ασφάλεια και την υγεία στην εργασία σχετικά με τον κορωνοϊό</p></a></li>
        <li><a href="#"><p style="color:black!important;">Οδηγίες για τους εργοδότες για τη διατήρηση ασφάλειας στους χώρους εργασίας κατά τη διάρκεια της πανδημίας</p></a></li>
        <li><a href="#"><p style="color:black!important;">Γενικές οδηγίες για τον έλεγχο και την πρόληψη του κορωνοϊού στην εργασία</p></a></li>
      </ul>

        <div id="topic2" style="margin-left: 30px; margin-top: 30px; text-decoration: underline;"><h3><strong>Μισθοί, Ώρες και Άδειες</strong></h3></div>

        <div id="topic3" style="margin-left: 30px; margin-top: 30px; text-decoration: underline;"><h3><strong>Ασφάλεια Ανεργίας</strong></h3></div>

        <div id="topic4" style="margin-left: 30px; margin-top: 30px; text-decoration: underline;"><h3><strong>Άλλα θέματα</strong></h3></div>
