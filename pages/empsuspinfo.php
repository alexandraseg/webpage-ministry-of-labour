...
<div class="wrapper row0">
  ...
  <div class="wrapper bgded overlay gradient" style="background-image:url('../images/demo/backgrounds/emp.png');">
    ...
    <h6 class="heading">Δήλωση Αναστολής Σύμβασης Εργασίας</h6>
      
      <ul>
        <li><a href="index.php">Αρχική</a></li>
        <li><a href="employers.php">Εργοδότες</a></li>
        <li><p class="active-breadcrumb">Δήλωση Αναστολής Σύμβασης Εργασίας<p></li>
      </ul>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content"> 
      <h1 style="text-transform:none;">Αναστολή Συμβάσεων Εργασίας</h1>

      <p>Επιχειρήσεις, των οποίων έχει ανασταλεί η λειτουργία με εντολή Δημόσιας Αρχής θέτουν το προσωπικό τους σε αναστολή και επιχειρήσεις, που πλήττονται σημαντικά, λόγω των αρνητικών συνεπειών του φαινόμενου του κορωνοϊού-COVID 19, όπως έχουν ορισθεί από το Υπουργείο Οικονομικών  βάσει ΚΑΔ, δύνανται να θέσουν σε αναστολή την σύμβαση εργασίας μέρους ή του συνόλου των εργαζομένων τους.</p>


      <p>Χρησιμοποιείστε τη διαδικτυακή φόρμα 
          <a href="suspension.php">Δήλωση Αναστολής Σύμβασης Εργασίας</a>
        για να δηλώσετε τους εργαζόμενους, για τους οποίους απαιτείται αυτό, λόγω των μέτρων κατά της εξάπλωσης του κορονοϊού.</p>
      <br>
      ...
      <button class="accordion">Ποιοι εργαζόμενοι τίθενται σε αναστολή εργασίας</button>
      <div class="panel">
         <br>
      ...
      <button class="accordion">Αρχή αναστολής - Χρονική διάρκεια αυτής</button>
      <div class="panel">
        <br>
