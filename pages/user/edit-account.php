    ...
    <div id="topbar" class="hoc clear">
      ...
      <ul class="nospace">
          ...
          <?php if ((isset($_SESSION["login"]) && $_SESSION["login"] == "OK")) {  ?>
                <li><a href="account.php" title="Ο λογαριασμός μου"><i class="fas fa-user"></i></a></li>
          <?php } else { ?>
                <li><a href="login.php" title="Σύνδεση"><i class="fas fa-sign-in-alt"></i></a></li>
                <li><a href="register.php" title="Εγγραφή"><i class="fas fa-edit"></i></a></li>
          <?php } ?>
          <li id="searchform">
            <div>
...
<div class="wrapper bgded overlay gradient" style="background-image:url('../../images/demo/backgrounds/user.jpg');">
  ...
  <h6 class="heading">Τροποποίηση Λογαριασμού</h6>
    
    <ul>
      <li><a href="../../index.php">Αρχική</a></li>
      <li><a href="account.php">Λογαριασμός</a></li>
      <li><p class="active-breadcrumb">Τροποποίηση Λογαριασμού<p></li>
    </ul>
        ...
        <div class="register-page-content">
            <div class="login-form">
                   <?php if (isset($_SESSION['change']) ) 
                      {
                          if ( $_SESSION['change'] == "id_number")
                          {
                              echo '<h4 style="color: red;">Ο Α.Δ.Τ. υπάρχει ήδη , βεβαιωθείτε ότι είναι σωστός !</h4>';
                          }
                          else if( $_SESSION['change'] == "afm")
                          {
                              echo '<h4 style="color: red;">Ο A.Φ.Μ. υπάρχει ήδη , βεβαιωθείτε ότι είναι σωστός !</h4>';
                          }
                          else if( $_SESSION['change'] == "username")
                          {
                              echo '<h4 style="color: red;">To όνομα χρήστη υπάρχει ήδη, πληκτρολογήστε άλλο!</h4>';
                          }
                          else if( $_SESSION['change'] == "email")
                          {
                              echo '<h4 style="color: red;">To email υπάρχει ήδη, , βεβαιωθείτε ότι είναι σωστό!</h4>';
                          }
                          else if( $_SESSION['change'] == "password")
                          {
                            echo '<h4 style="color: red;">Δεν μπορέσαμε να τρροποποιήσουμε τον κωδικό σας , προσπαθήστε ξανά!</h4>';
                          }
                          else
                          {
                  ...
                  ?>
                <h3>Τροποποίηση Λογαριασμού</h3>
                <form action="backend/edit-account.php" method = "post">
                    <div class="form-row">
                        <?php if ($_SESSION['type'] != '1') {?>
                        <div class="form-column">
                            <label id="id_number">A.Δ.Τ. </label>
                            <input name="id_number-change" type="text" placeholder="πχ ΑΒ102030" pattern="[a-zA-Z0-9]+"  >
                        </div>
                        <?php } else { ?>
                          <div class="form-column">
                            <label id="shopname">Επωνυμία Επιχείρησης </label>
                            <input name="shopname-change" type="text"pattern="[a-zA-Zα-ωΑ-Ω0-9 ,]+"  >
                        </div>
                        <?php }?>
                        <div class="form-column">
                            <label id="afm">Α.Φ.Μ. </label>
                            <input name="afm-change" type="text" placeholder="πχ 05039812345" pattern="[0-9]+">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-column">
                            <label id="username">Όνομα Χρήστη(username)</label>
                            <input name="username-change" type="text" pattern="[a-zA-Z0-9]+">
                        </div>
                        <div class="form-column">
                            <label id="email">E-mail</label>
                            <input name="email-change" type="email" placeholder="example@hotmail.com">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-column">
                            <label id="password">Κωδικός χρήστη</label>
                            <input name="password-change" type="password" pattern="[a-zA-Z0-9]+">
                        </div>
                        <div class="form-column">
                            <label id="password-verify">Επανάληψη κωδικού χρήστη</label>
                            <input name="password_verify-change" type="password" pattern="[a-zA-Z0-9]+">
                        </div>
                    </div>
                    <div class="form-row">                  
                        <div class = "form-column">
                            <label id="user-type">Eπιλέξτε την κατηγορία που ανήκετε</label>
                            <select name="user-type-change">
                                ...
                                <option value="5">Τίποτα από τα παραπάνω</option>  
                            </select> 
                        </div>
                        <?php if ($_SESSION['type'] != '1') {?>
                        <div class="form-column">
                            <label id="address">Διεύθυνση </label>
                            <input name="address-change" type="text"pattern="[a-zA-Zα-ωΑ-Ω0-9 ,]+"  >
                        </div>
                        <?php } else { ?>
                          <div class="form-column">
                            <label id="shopaddress">Διεύθυνση Επιχείρησης </label>
                            <input name="shopaddress-change" type="text"pattern="[a-zA-Zα-ωΑ-Ω0-9 ,]+"  >
                        </div>
                        <?php } ?>
                    </div>
                    <div class="log-btn">
                        <button type="submit" name="edit-account"><i class="fa fa-sign-in"></i>  Τροποποίηση</button>
                    </div>
                </form>
            </div>
                            
            <div style="position: relative; bottom: -25px; right:-530px; " >
                <a href="account.php">Πίσω</a>
            </div>
        </div>
    </section>
