  ...
  <div class="wrapper row0">
    <div id="topbar" class="hoc clear">
      ...
      <ul class="nospace">
          ...
          <li style="text-transform: capitalize;"><a href="pages/contact.php" title="Help Centre">Επικοινωνία</a></li>

          <?php if ((isset($_SESSION["login"]) && $_SESSION["login"] == "OK")) {  ?>
                <li><a href="pages/user/account.php" title="Ο λογαριασμός μου"><i class="fas fa-user"></i></a></li>
          <?php } else { ?>
                <li><a href="pages/user/login.php" title="Σύνδεση"><i class="fas fa-sign-in-alt"></i></a></li>
                <li><a href="pages/user/register.php" title="Εγγραφή"><i class="fas fa-edit"></i></a></li>
          <?php } ?>
          <li id="searchform">
            <div>
      ...
      <nav id="mainav" class="fl_right"> 
        ...
        <ul class="clear">
          ...
          <li><a class="drop" href="#">Ενδιαφερόμενοι</a>
            <ul>
              <li><a href="pages/employees.php">Εργαζόμενοι</a></li>
              <li><a href="pages/employers.php">Εργοδότες</a></li>
      ...
      <article>
        ...
        <div style="margin-top:15px;">
          <ul class="nospace inline pushright">
            <li><a class="btn" href="pages/covid.php"> Κατευθυντήριες Οδηγίες</a></li>
