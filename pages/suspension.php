...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content"> 
      <h1 style="text-transform:none;">Αναστολή Σύμβασης Εργασίας</h1>
               ...
               <!--  <h2 id="heading">Sign Up Your User Account</h2> -->
                ...
                <form id="msform"  action="successmessage.php"  method = "post">
                    ...
                    <ul id="progressbar">
                        ...
                        <li  id="empty"></li>
                        <li id="personal"><strong>Βήμα 2:<br>Προβολή, δήλωση και<br>επεξεργασία εργαζομένων</strong></li>
                  ...
                  <?php $_SESSION['redirect'] = 'suspension';?>
                ...
                <?php }?> 
                        ...
                        </div> <input type="button" name="next" class="next action-button" value="Επόμενο" 
...
<!--###  ΒΗΜΑ 2   ########################################### -->
                    ...
                    <fieldset>
                            ...
                            <div class="row">
                              ...
                              <div class="col-7">
                                    ...
                                    <!-- <form action="/action_page.php"> -->
                                      <label for="start">Έναρξη Αναστολής:</label>
                                      <input type="date" id="start" name="start">
                                      <label for="start">Λήξη Αναστολής:</label>
                                      <input type="date" id="start" name="start">
                        ...
                        </div> <input type="button" name="next" class="next action-button" value="Επόμενο" /> <input type="button" name="previous" class="previous action-button-previous" value="Πίσω" />
                    </fieldset>
                    <fieldset>
                        <div class="form-card">
                            <div class="row">
                            <div class="col-7">
                             ...
                             <div class="row justify-content-center">
                                <div class="col-7 text-center">
                                    <h5 class="purple-text text-center">Θα σας αποσταλεί email επιβεβαίωσης.</h5>
