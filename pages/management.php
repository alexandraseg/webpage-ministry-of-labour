...
<div class="wrapper row0">
  ...
  <div class="wrapper bgded overlay gradient" style="background-image:url('../images/demo/backgrounds/covid.jpg');">
    <div id="breadcrumb" class="hoc clear"> 
  
    <h6 class="heading">Διαχείριση περιστατικού</h6>
      
      <ul>
        <li><a href="index.php">Αρχική</a></li>
        <li><a href="covid.php">Κορωνοϊός - κατευθυντήριες οδηγίες</a></li>
        <li><p class="active-breadcrumb">Διαχείριση περιστατικού<p></li>
      </ul>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content"> 
      <h1 style="text-transform:none;">Διαχείριση περιστατικού εμφάνισης συμπτωμάτων στον χώρο εργασίας</h1>

      <p>Συμβουλευτείτε τον <a href="https://eody.gov.gr/orismoi-kroysmatos-covid-19-kai-epafon-kroysmatos-covid-19/">ΕΟΔΥ</a> σχετικά με τα είδη των κρουσμάτων και τα είδη των επαφών: </p>

      <button class="accordion">Είδη κρουσμάτων</button>
      <div class="panel">
        <ol>
          <li><span style="font-weight: bold;">Ενδεχόμενο:</span> <br/>
            <ul>
              <li>Ασθενής που πληροί τα κλινικά κριτήρια</li>
            </ul>
            
          </li>
          <li><span style="font-weight: bold;">Πιθανό:</span>
            <ul>
              <li>Ασθενής που πληροί τα κλινικά κριτήρια και ένα επιδημιολογικό κριτήριο, ή</li>
              <li>Άτομο που πληροί τα απεικονιστικά διαγνωστικά κριτήρια</li>
            </ul>
          </li>
          <li><span style="font-weight: bold;">Επιβεβαιωμένo:</span>
            <ul>
              <li>Άτομο που πληροί τα εργαστηριακά κριτήρια</li>
            </ul>
          </li>
      </ol>
     </div>

      <button class="accordion">Είδη επαφών</button>
      <div class="panel">
         <ol>
          <li><span style="font-weight: bold;">Στενή υψηλού κινδύνου:</span>
            <ul>
              <li>άτομο που είχε επαφή πρόσωπο με πρόσωπο με ασθενή με COVID-19 σε απόσταση < 2 μέτρων και για ≥ 15 λεπτά</li>
              <li>άτομο που είχε άμεση σωματική επαφή με ασθενή με COVID-19</li>
              <li>άτομο με απροφύλακτη επαφή με μολυσματικές εκκρίσεις ασθενή με COVID-19</li>
              <li>άτομο που παρέμεινε σε κλειστό χώρο (π.χ. οικία, αίθουσα διδασκαλίας ή συσκέψεων, χώρο αναμονής νοσοκομείου, κλπ.) με ασθενή με COVID-19 για περισσότερο από 15 λεπτά</li>
              <li>συνταξιδιώτης στο ίδιο αεροσκάφος, ο οποίος καθόταν σε απόσταση δύο σειρών θέσεων (προς κάθε κατεύθυνση) από τον ασθενή με λοίμωξη COVID-19 , άτομα που ταξίδευαν μαζί ή φρόντισαν τον ασθενή και μέλη του πληρώματος που εξυπηρέτησαν το συγκεκριμένο τμήμα του αεροσκάφους όπου καθόταν ο ασθενής (επί ύπαρξης σοβαρών συμπτωμάτων ή μετακινήσεων του ασθενούς εντός του αεροσκάφους, που ενδέχεται να συνεπάγονται περισσότερο εκτεταμένη έκθεση, οι επιβάτες που κάθονταν στο ίδιο τμήμα του αεροσκάφους ή ακόμη και όλοι οι επιβάτες της πτήσης μπορεί να θεωρηθούν στενές επαφές)</li>
              <li>επαγγελματίας υγείας ή άλλο άτομο που παρείχε άμεση φροντίδα σε ασθενή με COVID-19 ή εργαζόμενος σε εργαστήριο που χειρίστηκε κλινικό δείγμα ασθενούς με COVID-19, χωρίς λήψη ή επί αστοχίας των ενδεδειγμένων μέτρων ατομικής προστασίας.</li>
            </ul>
          </li>
          <br>
          <li><span style="font-weight: bold;">Απλή χαμηλού κινδύνου:</span>
            <ul>
              <li>άτομο που είχε επαφή πρόσωπο με πρόσωπο με ασθενή με COVID-19 εντός 2 μέτρων για < 15 λεπτά</li>
              <li>άτομο που παρέμεινε σε κλειστό χώρο με τον ασθενή με COVID-19 για < 15 λεπτά</li>
              <li>άτομο που ταξίδεψε μαζί με τον ασθενή με COVID-19 σε οποιοδήποτε μεταφορικό μέσο (εξαιρουμένης της περίπτωσης ταξιδιού με αεροσκάφος που περιγράφεται παραπάνω για τις στενές επαφές-έκθεση υψηλού κινδύνου)</li>
              <li>επαγγελματίας υγείας ή άλλο άτομο που παρείχε άμεση φροντίδα σε ασθενή με COVID-19 ή εργαζόμενος σε εργαστήριο που χειρίστηκε κλινικό δείγμα ασθενούς με COVID-19, με λήψη των ενδεδειγμένων μέτρων ατομικής προστασίας.</li>
            </ul>
          </li>
      </ol>
      </div>
      ...
      <h2 style="text-transform: none;">Πιθανά σενάρια</h2>

      <button class="accordion">O εργαζόμενος παρουσιάζει συμπτωματολογία ίωσης</button>
      <div class="panel">
        <br>Δεν έρχεται στην εργασία του, μένει στο σπίτι του, επικοινωνεί με τον θεράποντα ιατρό του και παραμένει εκτός εργασίας για όσο χρονικό διάστημα απαιτηθεί, προσκομίζοντας ιατρική βεβαίωση ή άδεια απουσίας λόγω ασθενείας από τον ασφαλιστικό του φορέα.<br><br>
      </div>
      <button class="accordion">Ο εργαζόμενος παρουσιάζει συμπτωματολογία ίωσης, έχει ιστορικό στενής επαφής, και επιβεβαιωμένο κρούσμα ιού τις προηγούμενες 14 μέρες</button>
      <div class="panel">
        <br>Δεν έρχεται στην εργασία του, μένει στο σπίτι του, επικοινωνεί με:
        <ul>
          <li>τον θεράποντα ιατρό του</li>
          <li>με τον ΕΟΔΥ (τηλ. 1135 για λήψη οδηγιών)</li>
          <li>με τον Προϊστάμενο του και μέσω αυτού με την Εταιρεία και</li>
          <li>υποβάλλεται σε τεστ ανίχνευσης του ιού</li>
        </ul>
      </div>
       <button class="accordion">Ο εργαζόμενος δεν έχει κανένα σύμπτωμα, αλλά έχει ιστορικό στενής επαφής, με ύποπτο ή επιβεβαιωμένο κρούσμα ιού</button>
      <div class="panel">
         <br>Δεν έρχεται στην εργασία του, μένει στο σπίτι του, επικοινωνεί με:
        <ul>
          <li>τον θεράποντα ιατρό του</li>
          <li>με τον ΕΟΔΥ (τηλ. 1135 για λήψη οδηγιών)</li>
          <li>με τον Προϊστάμενο του και μέσω αυτού με την Εταιρεία και</li>
          <li>ενδεχομένως υποβάλλεται σε τεστ ανίχνευσης του ιού</li>
        </ul>
      </div>
       <button class="accordion">Ο εργαζόμενος δεν έχει κανένα σύμπτωμα αλλά έχει ιστορικό απλής επαφής με ύποπτο ή επιβεβαιωμένο κρούσμα ιού</button>
      <div class="panel">
         <br>Έρχεται μεν στην εργασία του, παρακολουθώντας στενά τον εαυτό του για πιθανά συμπτώματα, ακολουθώντας  πιστά  τις  οδηγίες  ατομικής  υγιεινής.
      </div>


      <br>
      Όλα τα παραπάνω υπόκεινται σε αλλαγές σύμφωνα με τις οδηγίες των:
      <br>
      <ul>
        <li>Εθνικός Οργανισμός Δημόσιας Υγείας <a href="https://eody.goν.gr">https://eody.goν.gr</a></li>
        <li>Ευρωπαικό Κέντρο Πρόληψης Νοσημάτων <a href="https://ecdc.europa.eu">https://ecdc.europa.eu</a></li>
      </ul>
