  ...
  <div class="wrapper row1">
    <header id="header" class="hoc clear">
      ...
      <div class="wrapper bgded overlay gradient" style="background-image:url('../images/demo/backgrounds/covid.jpg');">
        ...
        <h6 class="heading">Μέτρα πρόληψης</h6>
          
          <ul>
            <li><a href="../index.php">Αρχική</a></li>
            <li><a href="covid.php">Κορωνοϊός - κατευθυντήριες οδηγίες</a></li>
            <li><p class="active-breadcrumb">Μέτρα πρόληψης <p></li>
          </ul>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <!-- ################################################################################################ -->
      <h1 style="text-transform:none;">Ιατρικές οδηγίες για την πρόληψη της διασποράς του ιού</h1>

      <ul>
        <li>Φοράτε παντού και πάντα την μάσκα σας.</li>
        <li>Μην ακουμπάτε την μάσκα σας με τα χέρια σας. Πιάστε μόνον τα λάστιχα για να την βάλετε και να την βγάλετε.</li>
        <li>Αν βήξετε ή φταρνιστείτε, καλύψτε το στόμα και τη μύτn σας επιπλέον με χαρτομάvτnλο.</li>
        <li>Πετάξτε αμέσως το χαρτομάντηλο στον κάδο απορριμμάτων.</li>
        <li>Πλένετε τακτικά τα χέρια σας με σαπούνι και νερό (τουλάχιστον για 30 δευτερόλεπτα - και τον αντίχειρα) ή χρησιμοποιείστε αλκοολούχο αντισηπτικό διάλυμα.</li>
        ...
        <li>Τηρείτε τις αποστάσεις και αποφεύγετε τον συγχρωτισμό</li>
        <li>Αερίζετε τους χώρους εργασίας επαρκώς (ανοιχτά παράθυρα, αποφυγή συγχρωτισμού).</li>
      </ul>
