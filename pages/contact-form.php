...
<div class="wrapper bgded overlay gradient"  style="background-image:url('../images/demo/backgrounds/contact.jpg');">
  ...
  <h6 class="heading">Επικοινωνήστε μαζί μας</h6>
    
    <ul>
        <li><a href="index.php">Αρχική</a></li>
      <li><a href="contact.php">Επικοινωνία</a></li>
      <li><p class="active-breadcrumb">Επικοινωνήστε μαζί μας</p></li>
    </ul>
      ...
      <div class="login-page-content">
        <div class="login-form">
            <?php
                ...
                {
                    echo '<h4 style="color:   green;">Λάβαμε το email σας και θα σας απαντήσουμε το συντομότερο δυνατόν!</h4> <br>';
                } 
            ?>
            <h3>Στείλτε μας το ερώτημα σας </h3>
              <form action="contact-form.php" method = "post">
                            ...
                            <?php if ($type == '1') {?>
                                ...
                                <div class="form-row">
                                    <div class="username">
                                        ...
                                        <input name="shopname" type="text" placeholder="<?= $row[1]?>" pattern="[a-zA-Zα-ωΑ-Ω ]+" disabled>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="password">
                                        <label id="contact-email">Email</label>
                                        <input name="email" type="email" placeholder="<?= $row[3]?>" disabled>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="password">
                                        <label id="contact-text">Το ερώτημα σας</label>
                                        <textarea style="border-color:white;" name="text" type="textarea"   pattern="[a-zA-Zα-ωΑ-Ω ]+" rows="4" cols="62" ></textarea>
                                    </div>
                                </div>
                            <?php } else if ($type == '2') {?>
                                <?php 
                    ...
                    <?php } ?>
                    <div class="log-btn">
                        <button type="submit" name="contact">  Αποστολή</button>
                    </div>
			    </form>
          </div>
